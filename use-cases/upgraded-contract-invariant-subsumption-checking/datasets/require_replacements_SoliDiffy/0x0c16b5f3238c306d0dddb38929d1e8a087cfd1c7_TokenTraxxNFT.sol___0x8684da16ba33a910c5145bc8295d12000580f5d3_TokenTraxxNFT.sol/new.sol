...
// File @openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721BurnableUpgradeable.sol@v4.8.1
...
// File @openzeppelin/contracts-upgradeable/token/ERC721/extensions/IERC721EnumerableUpgradeable.sol@v4.8.1
...
// File @openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721EnumerableUpgradeable.sol@v4.8.1
...
// File @openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721PausableUpgradeable.sol@v4.8.1
...
// File @openzeppelin/contracts-upgradeable/utils/CountersUpgradeable.sol@v4.8.1
    ...
    IERC721Custom
{
     ...
     * @param _uri uri string for that token
     * Requirement:
     * {_uri} length shouldm not be less than zero
     */
     ...
     * @param _uri uri string for that token
     */
    function batchMintTraxx(address[] calldata _to, string[] calldata _uri)
        external
        onlyRole(MINTER_ROLE)
    {
     ...
     * @param _owner addres of the owner.
     */
